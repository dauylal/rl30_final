...
def get_args_parser():
    ...
    parser.add_argument('--warmup_steps', type=int, default=1000, help='number of total iterations for warmup') #1000
    parser.add_argument('--total_iter', default=300000, type=int, help='number of total iterations to run') #300000
    ...
    parser.add_argument('--eval_iter', default=1000, type=int, help='evaluation frequency') #1000
