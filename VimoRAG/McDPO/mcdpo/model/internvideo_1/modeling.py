...
from mcdpo.model.internvideo_1.modules.until_module import PreTrainedModel, AllGather, CrossEn, LossWeight
from mcdpo.model.internvideo_1.modules.module_cross import CrossModel, CrossConfig, Transformer as TransformerClip
from mcdpo.model.internvideo_1.modules.our_module_cross import Transformer as TransformerVision
from mcdpo.model.internvideo_1.modules.xpool_transformer import Transformer as XpoolTransformer
from mcdpo.model.internvideo_1.modules.xpool_transformer import Transformer_self
from mcdpo.model.internvideo_1.modules.module_clip import CLIP, convert_weights
from mcdpo.model.internvideo_1.modules import clip_evl
from mcdpo.model.internvideo_1.modules.clip_evl.model_no_freeze_only_global import vit_only_global_l_sparse8_k400, vit_only_global_b_sparse8_k400
...
class CLIP4Clip(CLIP4ClipPreTrainedModel):
    ...
    def _loose_similarity(self, sequence_output,attention_mask, visual_output,video_mask, frames_fea,text_fea,sim_header="meanP"):
        ...
        if sim_header == "meanP" or sim_header =='biaffine':
            ...
            expand_text_fea = text_fea.unsqueeze(1).repeat(1, bsz, 1, 1).view(-1, text_fea.size()[1], text_fea.size()[2]) #[bsz*bsz, seq,hidden]
            ...
            expand_frames_fea = frames_fea.repeat(bsz, 1, 1) #[bsz*bsz,12,768]
            video_mask = video_mask.repeat(bsz,1) #[1,2,3...] [1,2,3,...]
