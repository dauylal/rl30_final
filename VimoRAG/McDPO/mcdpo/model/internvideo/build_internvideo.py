...
from mcdpo.model.internvideo.config import Config, eval_dict_leaf
from mcdpo.model.internvideo.utils import setup_internvideo2V


def build_internvideo(model_path):
    config = Config.from_file('mcdpo/model/internvideo/internvideo2_stage2_config_vision.py')
