...
class ScriptArguments:
    ...
    # flip preference
    flip_ratio: Optional[float] = field(
        default=0.0,
        metadata={"help": "ratio of pairs whose chosen choice is flipped between sample_1 and sample_2"}
    )
...
def main(script_args):
    ...
    train_dataset, eval_dataset = motiongpt_utils.build_dpo_dataset(
        ...
        flip_ratio=script_args.flip_ratio,
    )
    train_dataset = {
